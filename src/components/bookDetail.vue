<template>
    <div class="book-detail">
      ...
      <div class="detail-content" v-if="bookDetail">
        ...
        <div class="!loading">
          <div class="detail-intro" :class="{show5:!showmore}" @click="showmore = !showmore">
...
.ell{
  ...
  .detail-linear{
    ...
    background:linear-gradient(bottom,#fff,rgba(255,255,255,0) 8rem) no-repeat center bottom;
    .detail-top{
      position: fixed;
      display: flex;
      left:0;
